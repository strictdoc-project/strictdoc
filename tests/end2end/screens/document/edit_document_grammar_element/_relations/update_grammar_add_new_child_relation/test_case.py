...
class Test(E2ECase):
    def test(self):
        ...
        with SDocTestServer(
            ...
            form_edit_grammar_element.do_open_tab("Relations")
            grammar_relation_mid = (
                form_edit_grammar_element.do_add_grammar_relation()
            )
            form_edit_grammar_element.do_select_grammar_relation_type(
                grammar_relation_mid, "Child"
            )
            form_edit_grammar_element.do_fill_in_grammar_relation_role(
                grammar_relation_mid, "IsRefinedBy"
            )
