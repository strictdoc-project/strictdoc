    ...
    def test(self):
        ...
        with SDocTestServer(
            ...
            screen_project_index.assert_contains_document(
                "Requirements from Source Nodes"
            )
            ...
            requirement = screen_document.get_node(node_order=3)
            ...
            screen_document.do_drop_image_to_requirement(
                "STATEMENT",
                "./tests/end2end/screens/document/update_node/update_requirement_upload_image_autogen/picture.svg",
            )

            form_edit_requirement.do_form_submit()

            screen_document.assert_text(
                "[Image upload failed: Asset upload is disabled for autogenerated"
            )
