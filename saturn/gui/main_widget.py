...
from saturn.gui.document.document_item_delegate import DocumentItemDelegate
from saturn.gui.document.document_model import DocumentTableModel
from saturn.gui.styles import SATURN_QT_STYLES
...
class Widget(QWidget):
    def __init__(self, rst_document):
        ...
        # Styles
        self.table_view.setStyleSheet(SATURN_QT_STYLES)
