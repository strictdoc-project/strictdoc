...
path_to_expected_downloaded_file = os.path.join(
    DOWNLOADED_FILES_PATH, "ABC-123 Document with UID.pdf"
)
...
class Test(E2ECase):
    def test(self):
        ...
        with SDocTestServer(
            ...
            screen_project_index.assert_contains_document("Document with UID")

            screen_document = screen_project_index.do_click_on_first_document()

            screen_document.assert_on_screen_document()
            screen_document.assert_header_document_title("Document with UID")
