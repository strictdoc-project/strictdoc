...
class Test(E2ECase):
    def test(self):
        ...
        with SDocTestServer(
            ...
            relation1_mid = form_edit_grammar_element.do_add_grammar_relation()
            form_edit_grammar_element.do_fill_in_grammar_relation_role(
                relation1_mid, "ROLE"
            )

            relation2_mid = form_edit_grammar_element.do_add_grammar_relation()
            form_edit_grammar_element.do_fill_in_grammar_relation_role(
                relation2_mid, "ROLE"
            )

            form_edit_grammar_element.do_form_submit_and_catch_error(
