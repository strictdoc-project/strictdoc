"""
View Object class that bridges between the Eurobot test dashboard's
computed scopes/gaps and its Jinja templates.
...
@dataclass
class EurobotTestDashboardViewObject:
    def __init__(
        self,
        *,
        ...
        self.scopes: List[DashboardScope] = scopes
    ...
    def render_screen(self, jinja_environment: JinjaEnvironment) -> Markup:
        return jinja_environment.render_template_as_markup(
            "features/eurobot_test_dashboard/index.jinja", view_object=self
        )
